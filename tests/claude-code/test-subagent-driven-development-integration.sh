...
mkdir -p src test docs/superpowers-optimized/plans

# Create a simple implementation plan
cat > docs/superpowers-optimized/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/superpowers-optimized/plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Change to directory $TEST_PROJECT and then execute the implementation plan at docs/superpowers-optimized/plans/implementation-plan.md using the subagent-driven-development skill.
